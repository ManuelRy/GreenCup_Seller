    ...
    <style>
        * {
        ...
        @media print {
            ...
            .print-actions, .manual-entry-section {
                display: none;
            }
        ...
        <div class="receipt-summary">
            ...
            <div class="summary-grid">
                ...
                <div class="summary-item">
                    ...
                    <div class="summary-value">{{ \Carbon\Carbon::parse($receipt->created_at)->format('M d, Y g:i A') }}</div>
                </div>
            </div>
            ...
            @if($receipt->expires_at)
                <div class="expiry-info">
                    <div class="expiry-text">
                        ⏰ This receipt expires on {{ \Carbon\Carbon::parse($receipt->expires_at)->format('M d, Y g:i A') }}
                    </div>
                </div>
            @endif
